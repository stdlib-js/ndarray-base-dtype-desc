...
```javascript
import dtypeDesc from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-dtype-desc@v0.3.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-dtype-desc/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/ndarray-base-dtype-desc/actions/workflows/test.yml?query=branch:v0.3.0
